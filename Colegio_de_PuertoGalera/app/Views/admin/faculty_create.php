        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title mt-5">Add New Faculty</h3>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <form id="addFacultyForm" method="post" action="/faculty/store" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a href="/faculty" class="btn btn-secondary">Back to Faculty List</a>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-body text-center p-lg-4">
                    ...
                    <p class="mt-3">There was an error adding the faculty.</p>
