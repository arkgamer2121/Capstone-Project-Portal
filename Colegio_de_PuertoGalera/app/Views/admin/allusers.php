...
<div class="page-wrapper">
    ...
    <div class="dropdown dropdown-action">
        <a href="/useredit" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v ellipse_color"></i></a>
        <div class="dropdown-menu dropdown-menu-right">
            <a class="dropdown-item" href="<?= base_url('/useredit' . $user['id']) ?>"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
